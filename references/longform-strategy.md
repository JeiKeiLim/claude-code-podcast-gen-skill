...
### 30분 팟캐스트 (약 4,500 단어 KO / 4,800 단어 EN)

```
[인트로]        2분    ~300 단어
[섹션 1]        6분    ~900 단어    ← 핵심 주제 소개
[전환]          0.5분  ~75 단어
[섹션 2]        6분    ~900 단어    ← 심층 분석
[전환]          0.5분  ~75 단어
[섹션 3]        6분    ~900 단어    ← 반론/다른 시각
[전환]          0.5분  ~75 단어
[섹션 4]        5분    ~750 단어    ← 실용적 시사점
[마무리]        3분    ~450 단어
합계           30분   ~4,425 단어
```

### 60분 팟캐스트 (약 9,000 단어 KO / 9,600 단어 EN)
...
[전환]          0.5분
[섹션 2]        7분    ~1,050 단어
[중간 요약]     2분    ~300 단어     ← "여기까지 정리하면..."
[섹션 3]        7분    ~1,050 단어
[전환]          0.5분
[섹션 4]        7분    ~1,050 단어
[전환]          0.5분
[섹션 5]        7분    ~1,050 단어
[중간 요약]     2분    ~300 단어     ← "후반부로 넘어가기 전에..."
[섹션 6]        7분    ~1,050 단어
[전환]          0.5분
[섹션 7]        5분    ~750 단어    ← 시사점/전망
[마무리]        4분    ~600 단어
합계           60분   ~8,750 단어
```
...
60분 스크립트(~9,000 단어)는 단일 생성에서 품질이 떨어질 수 있다.
다음 전략으로 나눠 생성한다:
